...
(function ($) {
  ...
  $.Editable.prototype.processURLs = function () {
    this.$original_element.on('editable.afterPasteCleanup', function (e, editor, html) {
      if ($.Editable.URLRegEx.test(html)) {
        return html.replace($.Editable.URLRegEx, '$1<a href="$2">$2</a>$7')
      }
    });
