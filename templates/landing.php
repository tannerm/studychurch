...
the_post(); ?>
	...
	<section id="study-group" class="study-group" style="background: url('<?php echo get_template_directory_uri(); ?>/assets/images/bible.jpg') center center;">
		<div class="content-container">
			<h1>Engage your small group online</h1>
			...
			<p><a href="#" data-reveal-id="start-now" class="button secondary no-margin small round ucase wide">Sign up for free</a></p>
		</div>
	</section>
